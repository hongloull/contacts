"""
Provide a convenience way to output log to stream or file.
Usage:
log.write('write')
log.debug('debug')
"""
...
_ORDINARY = 25
logging.addLevelName(_ORDINARY, '_ORDINARY')
...
class CgLogger(logging.Logger):
    ...
    def write(self, msg, *args, **kwargs):
        self._log(_ORDINARY, msg, args, **kwargs)
